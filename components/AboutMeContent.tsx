...
const AboutMeContent: React.FC = () => {
  return (
    <div>
      <SectionTitle
        title='About Me'
        subtitle="I'm a passionate software engineer with a strong focus on creating elegant, efficient, and user-centered digital experiences."
      ...
      <div className='mt-6 space-y-4 text-muted-foreground p-5 rounded-xl terminal-glow bg-black/60 backdrop-blur-sm'>
        <div className='flex items-center gap-2 mb-2 pb-2 border-b border-white/10'>
          ...
          <div className='px-2 py-0.5 text-xs font-mono text-white/60'>
            ~ about-me.txt
          </div>
        </div>

        <p className='text-emerald-400 font-mono text-sm'>
          {"> "}With over 4 years of experience in web and mobile development,
        ...
        <p className='text-teal-400 font-mono text-sm'>
          {"> "}My approach to development is holistic - I believe that great
          software isn&apos;t just about clean code, but also about creating
          intuitive user experiences and solving real business problems.
        </p>

        <p className='text-cyan-400 font-mono text-sm'>
          {"> "}When I&apos;m not coding, you&apos;ll find me exploring new
          technologies, contributing to open-source projects, or sharing my
          knowledge through blog posts and mentoring junior developers.
        </p>
